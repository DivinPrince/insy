...
(() => {
  ...
  var require_html2canvas = __commonJS({
    "../../node_modules/.bun/html2canvas@1.4.1/node_modules/html2canvas/dist/html2canvas.js"(exports, module) {
      (function(global, factory) {
        ...
        var __assign = function() {
          __assign = Object.assign || function __assign2(t3) {
            for (var s3, i5 = 1, n2 = arguments.length; i5 < n2; i5++) {
              s3 = arguments[i5];
              for (var p3 in s3)
        ...
        function __spreadArray(to, from, pack2) {
          if (pack2 || arguments.length === 2)
            for (var i5 = 0, l3 = from.length, ar; i5 < l3; i5++) {
              if (ar || !(i5 in from)) {
                if (!ar)
        ...
        var Bounds = (
          ...
          function() {
            ...
            Bounds2.prototype.add = function(x2, y2, w3, h3) {
              return new Bounds2(this.left + x2, this.top + y2, this.width + w3, this.height + h3);
            };
        ...
        var decode$1 = function(base642) {
          var bufferLength = base642.length * 0.75, len = base642.length, i5, p3 = 0, encoded1, encoded2, encoded3, encoded4;
          ...
          for (i5 = 0; i5 < len; i5 += 4) {
            encoded1 = lookup$1$1[base642.charCodeAt(i5)];
            encoded2 = lookup$1$1[base642.charCodeAt(i5 + 1)];
            encoded3 = lookup$1$1[base642.charCodeAt(i5 + 2)];
            encoded4 = lookup$1$1[base642.charCodeAt(i5 + 3)];
        ...
        var polyUint16Array$1 = function(buffer) {
          ...
          for (var i5 = 0; i5 < length; i5 += 2) {
            bytes.push(buffer[i5 + 1] << 8 | buffer[i5]);
          }
          return bytes;
        };
        var polyUint32Array$1 = function(buffer) {
          ...
          for (var i5 = 0; i5 < length; i5 += 4) {
            bytes.push(buffer[i5 + 3] << 24 | buffer[i5 + 2] << 16 | buffer[i5 + 1] << 8 | buffer[i5]);
          }
          return bytes;
        };
        ...
        var isHex = function(codePoint) {
          return isDigit(codePoint) || codePoint >= A2 && codePoint <= F2 || codePoint >= a3 && codePoint <= f4;
        };
          ...
          parse: function(context, value) {
            ...
            if (value.type === 5) {
              if (value.value.length === 3) {
                ...
                return pack(parseInt(r3 + r3, 16), parseInt(g2 + g2, 16), parseInt(b + b, 16), 1);
              }
              if (value.value.length === 4) {
                ...
                return pack(parseInt(r3 + r3, 16), parseInt(g2 + g2, 16), parseInt(b + b, 16), parseInt(a4 + a4, 16) / 255);
              }
              if (value.value.length === 6) {
                var r3 = value.value.substring(0, 2);
                var g2 = value.value.substring(2, 4);
                var b = value.value.substring(4, 6);
                return pack(parseInt(r3, 16), parseInt(g2, 16), parseInt(b, 16), 1);
              }
              if (value.value.length === 8) {
                ...
                return pack(parseInt(r3, 16), parseInt(g2, 16), parseInt(b, 16), parseInt(a4, 16) / 255);
              }
            }
            if (value.type === 20) {
        ...
        var pack = function(r3, g2, b, a4) {
          return (r3 << 24 | g2 << 16 | b << 8 | Math.round(a4 * 255) << 0) >>> 0;
        };
        var getTokenColorValue = function(token, i5) {
          ...
          if (token.type === 16) {
            var max = i5 === 3 ? 1 : 255;
            return i5 === 3 ? token.number / 100 * max : Math.round(token.number / 100 * max);
          }
          return 0;
        };
        var rgb = function(_context, args) {
          ...
          if (tokens.length === 3) {
            var _a = tokens.map(getTokenColorValue), r3 = _a[0], g2 = _a[1], b = _a[2];
            return pack(r3, g2, b, 1);
          }
          if (tokens.length === 4) {
            var _b = tokens.map(getTokenColorValue), r3 = _b[0], g2 = _b[1], b = _b[2], a4 = _b[3];
            return pack(r3, g2, b, a4);
          }
          return 0;
        };
        ...
        var hsl = function(context, args) {
          ...
          return pack(r3 * 255, g2 * 255, b * 255, a4);
        };
        ...
        var processColorStops = function(stops, lineLength) {
          ...
          return stops.map(function(_a, i6) {
            var color2 = _a.color;
            return { color: color2, stop: Math.max(Math.min(1, processStops[i6] / lineLength), 0) };
          });
        };
          ...
          switch (gradient.size) {
            ...
            case 2:
              if (gradient.shape === 0) {
                ...
                var c3 = Math.min(Math.abs(y2), Math.abs(y2 - height)) / Math.min(Math.abs(x2), Math.abs(x2 - width));
                var _a = findCorner(width, height, x2, y2, true), cx = _a[0], cy = _a[1];
                rx = distance(cx - x2, (cy - y2) / c3);
                ry = c3 * rx;
              }
              break;
            case 1:
            ...
            case 3:
              if (gradient.shape === 0) {
                ...
                var c3 = Math.max(Math.abs(y2), Math.abs(y2 - height)) / Math.max(Math.abs(x2), Math.abs(x2 - width));
        ...
        var testIOSLineBreak = function(document2) {
          ...
          var textList = toCodePoints$1(node.data).map(function(i5) {
        ...
        var getCurvePoints = function(x2, y2, r1, r22, position2) {
                  ...
                  switch (_b.label) {
                    case 0:
                      ...
                      _loop_1 = function(backgroundImage3) {
                        var image2, url, _c, path, x2, y2, width, height, pattern, _d, path, x2, y2, width, height, _e, lineLength, x0, x1, y0, y1, canvas, ctx, gradient_1, pattern, _f, path, left, top_1, width, height, position2, x2, y2, _g, rx, ry, radialGradient_1, midX, midY, f5, invF;
                              ...
                              if (isLinearGradient(backgroundImage3)) {
                                ...
                                if (rx > 0 && ry > 0) {
                                  ...
                                  if (rx !== ry) {
                                    ...
                                    this_1.ctx.transform(1, 0, 0, f5, 0, 0);
                                    this_1.ctx.translate(-midX, -midY);
  ...
  __export(capture_exports, {
    ...
    extractSourceHints: () => extractSourceHints
  });
  function captureElement(element) {
    ...
    return {
      ...
      boundingBox,
      html: element.outerHTML.substring(0, 1e3),
      css,
      xpath,
      cssSelector
    };
  }
  function captureBoundingBox(element) {
  ...
  function generateCSSSelector(element) {
    ...
    while (current && current !== document.body) {
      ...
      if (current.className) {
        const classes = current.className.split(" ").filter((c3) => c3.trim()).map((c3) => `.${c3}`).join("");
        selector += classes;
      }
  ...
  function extractSourceHints(element) {
    ...
    if (dataSource) {
      ...
      return {
        dataSource,
        filename,
        lineNumber: lineNumber ? parseInt(lineNumber, 10) : void 0
      };
    }
    return void 0;
  }
  ...
  // ../../node_modules/.bun/preact@10.28.0/node_modules/preact/dist/preact.module.js
  var n;
  var l;
  var u;
  var t;
  ...
  function P(n2, l3, u4, t3, i4) {
    ...
    for (n2.__k = new Array(i4), r3 = 0; r3 < i4; r3++)
      null != (o3 = l3[r3]) && "boolean" != typeof o3 && "function" != typeof o3 ? ("string" == typeof o3 || "number" == typeof o3 || "bigint" == typeof o3 || o3.constructor == String ? o3 = n2.__k[r3] = m(null, o3, null, null, null) : w(o3) ? o3 = n2.__k[r3] = m(k, { children: o3 }, null, null, null) : null == o3.constructor && o3.__b > 0 ? o3 = n2.__k[r3] = m(o3.type, o3.props, o3.key, o3.ref ? o3.ref : null, o3.__v) : n2.__k[r3] = o3, f4 = r3 + h3, o3.__ = n2, o3.__b = n2.__b + 1, -1 != (c3 = o3.__i = L(o3, u4, f4, a3)) && (a3--, (e3 = u4[c3]) && (e3.__u |= 2)), null == e3 || null == e3.__v ? (-1 == c3 && (i4 > s3 ? h3-- : i4 < s3 && h3++), "function" != typeof o3.type && (o3.__u |= 4)) : c3 != f4 && (c3 == f4 - 1 ? h3-- : c3 == f4 + 1 ? h3++ : (c3 > f4 ? h3-- : h3++, o3.__u |= 4))) : n2.__k[r3] = null;
    if (a3)
      for (r3 = 0; r3 < s3; r3++)
  ...
  function O(n2, u4, t3, i4, r3, o3, e3, f4, c3, s3) {
    ...
    n:
      if ("function" == typeof j3)
        try {
          if (b = u4.props, S2 = "prototype" in j3 && j3.prototype.render, C2 = (a3 = j3.contextType) && i4[a3.__c], M2 = a3 ? C2 ? C2.props.value : a3.__ : i4, t3.__c ? m3 = (h3 = u4.__c = t3.__c).__ = h3.__E : (S2 ? u4.__c = h3 = new j3(b, M2) : (u4.__c = h3 = new x(b, M2), h3.constructor = j3, h3.render = E), C2 && C2.sub(h3), h3.state || (h3.state = {}), h3.__n = i4, p3 = h3.__d = true, h3.__h = [], h3._sb = []), S2 && null == h3.__s && (h3.__s = h3.state), S2 && null != j3.getDerivedStateFromProps && (h3.__s == h3.state && (h3.__s = d({}, h3.__s)), d(h3.__s, j3.getDerivedStateFromProps(b, h3.__s))), v3 = h3.props, y2 = h3.state, h3.__v = u4, p3)
  ...
  function q(u4, t3, i4, r3, o3, e3, f4, c3, s3) {
    var a3, h3, v3, y2, d3, _2, m3, b = i4.props || p, k3 = t3.props, x2 = t3.type;
  ...
  var ElementSelector = class {
    constructor() {
      ...
      __publicField(this, "onSelectCallback");
      __publicField(this, "handleMouseMove", (e3) => {
        ...
        this.showLabel(element, e3);
      });
      __publicField(this, "handleClick", (e3) => {
      ...
      __publicField(this, "handleKeyDown", (e3) => {
        if (e3.key === "Escape") {
          this.deactivate();
        }
      });
    ...
    showLabel(element, e3) {
      ...
      this.label.style.left = `${e3.clientX + 10}px`;
      this.label.style.top = `${e3.clientY + 10}px`;
    }
    hideOverlay() {
      if (this.overlay) {
  ...
  function detectFramework() {
    ...
    if (window.next || document.getElementById("__next")) {
      return {
        type: "nextjs",
    ...
    if (window.__VUE__ || window.__VUE_DEVTOOLS_GLOBAL_HOOK__) {
      return {
        type: "vue",
        version: window.__VUE__?.version || detectVueVersion(),
  ...
  function captureReactContext(element) {
  ...
  function captureVueContext(element) {
  ...
  function captureHtmlContext(element) {
    const attributes = {};
  ...
  function captureFrameworkContext(element, framework) {
    if (framework.type === "react" || framework.type === "nextjs") {
      return captureReactContext(element) || void 0;
    }
    if (framework.type === "vue") {
      return captureVueContext(element) || void 0;
    }
  ...
  // ../../node_modules/.bun/preact@10.28.0/node_modules/preact/hooks/dist/hooks.module.js
  var t2;
  var r2;
  var u2;
  var i2;
  ...
  // ../../node_modules/.bun/preact@10.28.0/node_modules/preact/jsx-runtime/dist/jsxRuntime.module.js
  var f3 = 0;
  ...
  var PromptInput = ({
    ...
    return /* @__PURE__ */ u3(
      "div",
      {
        ...
        children: /* @__PURE__ */ u3("form", { onSubmit: handleSubmit, children: [
          /* @__PURE__ */ u3("div", { style: { marginBottom: "8px", fontSize: "14px", fontWeight: "600", color: "#374151" }, children: "What would you like to change?" }),
          /* @__PURE__ */ u3(
            "input",
            {
              type: "text",
              ...
              onFocus: (e3) => {
                e3.target.style.borderColor = "#3b82f6";
              },
              onBlur: (e3) => {
                e3.target.style.borderColor = "#e5e7eb";
              }
            }
          ),
          /* @__PURE__ */ u3("div", { style: { display: "flex", gap: "8px", marginTop: "12px", justifyContent: "flex-end" }, children: [
            /* @__PURE__ */ u3(
              "button",
              {
                type: "button",
  ...
  var DiffViewer = ({ diff, onApply, onReject }) => {
    return /* @__PURE__ */ u3(
      "div",
      {
        style: {
        ...
        children: [
          /* @__PURE__ */ u3("div", { style: { marginBottom: "16px" }, children: [
            /* @__PURE__ */ u3("div", { style: { fontSize: "18px", fontWeight: "600", color: "#111827", marginBottom: "4px" }, children: "Review Changes" }),
            /* @__PURE__ */ u3("div", { style: { fontSize: "14px", color: "#6b7280" }, children: diff.file })
          ] }),
          /* @__PURE__ */ u3(
            "div",
            {
              ...
              children: /* @__PURE__ */ u3(
                "pre",
                {
                  ...
                  children: diff.hunks.map((hunk, hunkIdx) => /* @__PURE__ */ u3("div", { children: [
                    /* @__PURE__ */ u3(
                      "div",
                      {
                        style: {
                    ...
                    hunk.changes.map((change, changeIdx) => /* @__PURE__ */ u3(
                      "div",
                      {
                        style: {
                          backgroundColor: change.type === "add" ? "#d1fae5" : change.type === "remove" ? "#fee2e2" : "transparent",
                          color: change.type === "add" ? "#065f46" : change.type === "remove" ? "#991b1b" : "#374151",
                          paddingLeft: "8px"
                        },
                        children: [
                          /* @__PURE__ */ u3(
                            "span",
                            {
                              ...
                              children: change.type === "add" ? "+" : change.type === "remove" ? "-" : " "
                            }
                          ),
                          change.line
                        ]
          ...
          /* @__PURE__ */ u3("div", { style: { display: "flex", gap: "12px", justifyContent: "flex-end" }, children: [
            /* @__PURE__ */ u3(
              "button",
              {
                onClick: onReject,
  ...
  // src/ui/loading.tsx
  var Loading = ({ stage, message, progress }) => {
    return /* @__PURE__ */ u3(
      "div",
      {
        style: {
        ...
        children: [
          /* @__PURE__ */ u3("div", { style: { display: "flex", alignItems: "center", gap: "12px", marginBottom: "8px" }, children: [
            /* @__PURE__ */ u3(
              "div",
              {
                style: {
            ...
            /* @__PURE__ */ u3("div", { style: { fontSize: "14px", fontWeight: "600", color: "#111827" }, children: stage })
          ] }),
          /* @__PURE__ */ u3("div", { style: { fontSize: "13px", color: "#6b7280", marginLeft: "32px" }, children: message }),
          progress !== void 0 && /* @__PURE__ */ u3(
            "div",
            {
              style: {
                marginTop: "12px",
  ...
  // src/ui/toast.tsx
  var Toast = ({ message, variant = "info", onClose }) => {
    const colors = {
      info: "bg-blue-500",
    ...
    return /* @__PURE__ */ u3(
      "div",
      {
        style: {
          ...
          padding: "12px 20px",
          borderRadius: "8px",
          backgroundColor: variant === "error" ? "#ef4444" : variant === "success" ? "#10b981" : variant === "warning" ? "#f59e0b" : "#3b82f6",
          color: "white",
  ...
  var Insy = class {
    ...
    setupKeyboardShortcut() {
      document.addEventListener("keydown", (e3) => {
        if ((e3.metaKey || e3.ctrlKey) && e3.shiftKey && e3.key.toLowerCase() === "e") {
          e3.preventDefault();
          e3.stopPropagation();
          this.toggle();
        }
      ...
      this.ws.on((message) => {
        switch (message.type) {
          case "status:update":
            ...
            break;
          case "diff:generated":
            this.handleDiffGenerated(message.payload);
            break;
          case "diff:applied":
    ...
    handleElementSelect(element, info) {
      ...
      this.currentElementId = crypto.randomUUID();
      this.ws.send(
    ...
    handleStatusUpdate(payload) {
      G(
        /* @__PURE__ */ u3(Loading, { stage: payload.stage, message: payload.message, progress: payload.progress }),
        this.uiContainer
      );
    }
    handleDiffGenerated(payload) {
      const diff = {
        id: payload.diffId,
        file: payload.file,
        ...
        hunks: []
        // Will be parsed from unifiedDiff
      };
      G(
        /* @__PURE__ */ u3(
          DiffViewer,
    ...
    showLoading(stage, message) {
      G(/* @__PURE__ */ u3(Loading, { stage, message }), this.uiContainer);
    }
